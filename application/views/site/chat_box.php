...
<div class="commn_dasboard p_120">
	...
	<section class="content chat-box-main">
        <?php echo $this->session->flashdata('msgs'); ?>
        <div class="error-msg"></div>

        <div class="row">
            <!-- left column -->
            <div class="col-md-12 right_messge right_message_show">
            <div class="hedadeer_riht">
            <h2>
                <?php 
                    //$user_id=$this->session->userdata('user_id');
                    //$user = $this->common_model->GetSingleData('users',array('user_id'=>$result1['user_id']));
            ...
            <form action="<?php echo base_url();?>reply-action" method="post">
                <ul class="ul_set" id="response">
                    <?php 
                     ...
                     ?>  
			                ...
			                <input type="hidden" name="email" id="email" value="<?php echo $result['email'];?>" />
