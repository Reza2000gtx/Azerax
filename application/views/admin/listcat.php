								...
								<div class="modal" id="myModal<?php echo $row['id']; ?>">
								  <div class="modal-dialog">
								    <div class="modal-content">
								     ...
								     <form method="post" onsubmit="return editcategory(<?php echo $row['id']; ?>
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">);" id="editcategory<?php echo $row['id']; ?>">
