...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">Admin/Footer_content/about_us" name="f3" id="f3">
                 	<div class="box-body">
