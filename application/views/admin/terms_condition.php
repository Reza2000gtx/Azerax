...
<div class="content-wrapper">
    <section class="content-header">
		<h1>Terms and Condition<small>Manage</small></h1>
		<ol class="breadcrumb">
                 ...
                 <form method="post" action="<?php echo base_url() ?>Admin/Footer_content/addterms" name="f3" id="f3">
                 	<div class="box-body">
						...
						<div class="form-group">
							<label></label>
							<textarea name="term_condition" id="term_condition" class="form-control ckeditor" required="" ><?php echo $value['term_condition']; ?></textarea>
						</div>
					<?php	} ?>
