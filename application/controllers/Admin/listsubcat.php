...
<div class="content-wrapper">
    <section class="content-header">
		<h1>Subcategory<small>Manage</small></h1>
		<ol class="breadcrumb">
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						...
						<button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#myModal">Add Subcategory</button>
						<?php	} ?>
					</div>
							...
							<tbody>
								...
								<tr>
									...
									<?php if($admin_permission_single && $admin_permission_single['edit']=='YES') { ?>
										...
										<button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#myModal<?php echo $row['cat_id']; ?>"><i class="fa fa-edit"></i></button>
										<?php	} ?>
										<?php if($admin_permission_single && $admin_permission_single['delete']=='YES') { ?>
										<a onclick="return confirm('Are you sure want to delete this subcategory?');" href="<?php echo base_url(); ?>Admin/Subcategory/deletesubcat/<?php echo $row['id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash" aria-hidden="true"></i></a>
										<?php	} ?>
									</td>
								</tr>
								<!-- The Modal -->
								<div class="modal" id="myModal<?php echo $row['cat_id']; ?>">
								  <div class="modal-dialog">
								    <div class="modal-content">
								     ...
								     <form method="post" onsubmit="return editsubcategory(<?php echo $row['cat_id']; ?>);" id="editsubcategory<?php echo $row['cat_id']; ?>">
									  ...
									  <div class="form-group">
								       ...
								       <div class="form-group">
								       	...
								       	<textarea class="form-control" name="sub_desc"><?php echo $row['sub_desc']; ?></textarea> 
								       					...
								       					<div class="form-group">
       	<label>Ads Script</label>
       	<textarea class="form-control" name="ads_script"><?php echo $row['ads_script']; ?></textarea> 
       </div> 
								      </div>
    ...
    <div class="modal-content">
     ...
     <form method="post" onsubmit="return addsubcategory();" id="addsubcategory">
      ...
      <div class="form-group">
       ...
       <div class="form-group">
       	<label>Ads Script</label>
       	<textarea class="form-control" name="ads_script"></textarea> 
       </div>
      </div>
      <!-- Modal footer -->
      <div class="modal-footer">
